...
class BasePageHelper:
    ...
    @allure.step('Нажимаем кнопку "Сервисы VK"')
    ...
    def click_more_button(self):
        more_button = self.find_element(BasePageLocators.MORE_BUTTON)
        ActionChains(self.driver).move_to_element(more_button).perform()
        self.attach_screenshot()
        more_button.click()
